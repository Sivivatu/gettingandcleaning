...
featuresfile <- "~/R/gettingandcleaning/UCI HAR Dataset/features.txt"
...
xtrainfile <- "~/R/gettingandcleaning/UCI HAR Dataset/train/X_train.txt"
ytrainfile <- "~/R/gettingandcleaning/UCI HAR Dataset/train/y_train.txt"
subjecttrainfile <- "~/R/gettingandcleaning/UCI HAR Dataset/train/subject_train.txt"
